...
public class CustomVec3 {
     ...
     */
    public static CustomVec3 createVectorHelper(double p_72443_0_, double p_72443_2_, double p_72443_4_)
    {
        return new CustomVec3(p_72443_0_, p_72443_2_, p_72443_4_);
    }

    public CustomVec3(double p_i1108_1_, double p_i1108_3_, double p_i1108_5_)
    {
        if (p_i1108_1_ == -0.0D)
        {
            p_i1108_1_ = 0.0D;
     ...
     */
    public CustomVec3 setComponents(double p_72439_1_, double p_72439_3_, double p_72439_5_)
    {
     ...
     */
    public CustomVec3 subtract(Vec3 p_72444_1_)
    {
        /**
    ...
    public double dotProduct(CustomVec3 p_72430_1_)
    {
     ...
     */
    public CustomVec3 crossProduct(CustomVec3 p_72431_1_)
    {
        /**
         * Static method for creating a new Vec3D given the three x,y,z values. This is only called from the other
         * static method which creates and places it in the list.
     ...
     * vector.
     */
    public CustomVec3 addVector(double p_72441_1_, double p_72441_3_, double p_72441_5_)
    {
        /**
         * Static method for creating a new Vec3D given the three x,y,z values. This is only called from the other
         * static method which creates and places it in the list.
     ...
     */
    public double distanceTo(CustomVec3 p_72438_1_)
    {
     ...
     */
    public double squareDistanceTo(CustomVec3 p_72436_1_)
    {
     ...
     */
    public CustomVec3 getIntermediateWithXValue(CustomVec3 p_72429_1_, double p_72429_2_)
    {
     ...
     * passed in vector, or null if not possible.
     */
    public CustomVec3 getIntermediateWithYValue(CustomVec3 p_72435_1_, double p_72435_2_)
    {
     ...
     * passed in vector, or null if not possible.
     */
    public CustomVec3 getIntermediateWithZValue(CustomVec3 p_72434_1_, double p_72434_2_)
    {
