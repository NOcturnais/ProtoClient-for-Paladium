...
/**
 * Replica of GuiMainMenu to get public methods
 * (to prevent from code bullshit in CMainMenu)
 * 			  /!\ Shit Code /!\
 */
public class MCMainMenu extends GuiScreen {
    ...
    {
        this.mc.getTextureManager().bindTexture(mc.getTextureManager().getDynamicTextureLocation("background", this.viewportTexture));
